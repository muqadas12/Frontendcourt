...
import signup from "../../../assets/Images/judl.PNG"
import {Link} from "react-router-dom";
import "./Sign.css"
import axios from "axios"
class JudgeSignUp extends Component {
...
//form validation starts
  ...
  authSubmithandler = async event => {
    ...
    axios.post('http://localhost:2000/api/users/signUp', data).then(res => {
      ...
      window.location = "http://localhost:3000/LoginJudge";
  ...
  render (props) {
    ...
    return (
      <form onSubmit={this.authSubmithandler} className="Form">
        ...
        <h5 className="judge-sign">Welcome to Judge dashboard</h5>
        ...
        <button type="submit" className="judge-sign-btn"
        ...
        >
          ...
          <div className="already-user"><p>Already a user?Need<Link to={'/LoginJudge'}> Sign In</Link> </p></div>
        </Wrap>
      </form>
    )
  }
