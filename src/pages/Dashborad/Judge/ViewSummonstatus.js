...
const ViewSummonstatus = () => {
  ...
  return (
    ...
    <div>
        <img className="arrestwarr-image" src={arrestwarrant} alt="summonstatus"/>
...
<div>                   
     ...
     <p>If the Summon is serve and person not appeared within due days in court the juge issue arrest warrant</p>
           ...
           <Link to="/ArrestWarrant"><img className="icon-arrest"  src={arrestwarranticon} alt="viewsummn"/></Link> 
           <Link to="/ArrestWarrant"  className="click-arrest">Click here to issue arrest warrant</Link>
    </div>

  )
}
export default ViewSummonstatus;
