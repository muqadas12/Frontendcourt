...
//     }
//     const handleHearing = e => {
//         e.preventDefault();
//         axios({
//             method: 'post',
//             url: 'http://localhost:3001/api/hearing/addHearing',
//             data: {
//                 name: data.name,
//                 cnic: data.cnic,
...
//             }
//         }).then(res => {
//             alert("Case Approved hor hiring")
//         }).catch(err => {
//             alert("Error Occured")
//         });
//     }
...
//                 </table>
//                 <form style={{ marginTop: "150px" }} class="form" onSubmit={handleSubmit} >
//                     <Row>
//                         <Col lg={12} md={12} sm={24} xs={24}>
//                             <label class="casenumber" htmlFor="casenumber">
//                                 Choose Hearing Date
...
//                                     style={{ width: "170%", height: "40px", border: "0.1px solid black" }} type="date" placeholder="Case Number" />
//                             </label>
//                         </Col>
//                         <Col lg={12} md={12} sm={24} xs={24}>
//                             <button onClick={handleHearing} class="btn">Approve Case</button> <br /><br />
